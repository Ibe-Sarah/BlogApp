...
/* harmony export */   "PostDetailPage": () => (/* binding */ PostDetailPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _post_detail_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./post-detail.page.html?ngResource */ 7896);
/* harmony import */ var _post_detail_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./post-detail.page.scss?ngResource */ 8033);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 2560);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 124);
/* harmony import */ var _shared_wp_ionic_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/wp-ionic.service */ 5053);
...
let PostDetailPage = class PostDetailPage {
    constructor(activatedRoute, wpService) {
    ...
    goToOrgPost() {
        window.open('https://sayrahcreation.000webhostapp.com/');
    }
};
PostDetailPage.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__.ActivatedRoute },
    { type: _shared_wp_ionic_service__WEBPACK_IMPORTED_MODULE_2__.WpIonicService }
];
PostDetailPage = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        selector: 'app-post-detail',
        template: _post_detail_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_post_detail_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], PostDetailPage);
...
/***/ 5053:
/*!********************************************!*\
  !*** ./src/app/shared/wp-ionic.service.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "WpIonicService": () => (/* binding */ WpIonicService)
/* harmony export */ });
...
let WpIonicService = class WpIonicService {
    constructor(httpClient) {
        this.httpClient = httpClient;
        this.endpoint = `https://sayrahcreation.000webhostapp.com/wp-json/wp/v2/`;
        this.allPosts = null;
    }
    getAllPosts(page = 1) {
        let options = {
        ...
        return this.httpClient.get(`${this.endpoint}posts?per_page=5`, options)
    ...
    postDetails(id) {
        return this.httpClient.get(`${this.endpoint}posts/${id}?_embed`)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_0__.map)((post) => {
            return post;
        }));
    }
};
WpIonicService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
WpIonicService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_home_sayrah_BlogApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_home_sayrah_BlogApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_sayrah_BlogApp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
/***/ 8033:
/*!**************************************************************!*\
  !*** ./src/app/post-detail/post-detail.page.scss?ngResource ***!
  \**************************************************************/
/***/ ((module) => {

module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJwb3N0LWRldGFpbC5wYWdlLnNjc3MifQ== */";

/***/ }),

/***/ 7896:
/*!**************************************************************!*\
  !*** ./src/app/post-detail/post-detail.page.html?ngResource ***!
  \**************************************************************/
/***/ ((module) => {

module.exports = "<ion-header>\n  <ion-toolbar color=\"danger\">\n    <ion-buttons slot=\"start\">\n      <ion-back-button defaultHref=\"/posts\"></ion-back-button>\n    </ion-buttons>\n    <ion-title>{{ postDetial?.title.rendered }}</ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content padding>\n  <div *ngIf=\"postDetial\">\n    <div [innerHTML]=\"postDetial.content.rendered\" padding></div>\n  </div>\n \n</ion-content>\n<ion-footer color=\"secondary\">\n  <ion-toolbar>\n    <ion-button expand=\"full\" fill=\"solid\" (click)=\"goToOrgPost()\">\n      Check Original Post\n    </ion-button>\n  </ion-toolbar>\n</ion-footer>";
